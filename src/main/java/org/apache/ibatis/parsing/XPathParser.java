...
public class XPathParser {
   ...
   /**
   * XML Document对象
   * XML被解析后，生成的 org.w3c.dom.Document 对象。
   */
   ...
   * 还会导致下载不下来，那么就会出现 XML 校验失败的情况。所以，在实际场景下，MyBatis自定义了 EntityResolver 的实现，
  ...
  private Properties variables;
   ...
   /**
   * javax.xml.xpath.XPath 对象，用于查询 XML 中的节点和元素,用来替换需要动态配置的属性值。。
   */
  private XPath xpath;
